...
import com.momforoneday.momforoneday.fragment.CaregiverFragment;
...
import com.momforoneday.momforoneday.fragment.RedirectFragment;
...
public class MainActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
               ...
               case R.id.navigation_config:
                    fragmentTransaction =
                            getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.content, new RedirectFragment());
                    fragmentTransaction.commit();
                    return true;
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CaregiverFragment.CAPTURE_IMAGE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                FirebaseController.storageImage(AppService.getContractedCaregiver().getContract(), data);
            }
        }
    }
